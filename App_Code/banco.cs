...
public class Banco
{
    ...
    public Banco()
    {
        ...
        //AppDomain.CurrentDomain.SetData("DataDirectory", @"D:\web\localuser\freevoproducoes\www\brindes\App_Data");
        //_strConexao = @"Data Source=servidorBD\nomeInstancia;Initial Catalog=nomeBD;Persist Security Info=True;User ID=loginUserBD;Password=senhaUserBD";
        //_strConexao = @"Data Source=D:\web\localuser\freevoproducoes\www\dados\dbSite.mdf;AttachDbFilename=D:\web\localuser\freevoproducoes\www\dados\dbSite.mdf;Integrated Security=True";
        //_strConexao = @"Data Source=freevoproducoes.com.br; AttachDbFilename=D:\web\localuser\freevoproducoes\www\dados\dbSite.mdf;Trusted_Connection=Yes;";
        //_strConexao =@"Data Source=(LocalDB)\v11.0;AttachDbFilename=D:\web\localuser\freevoproducoes\www\dados\dbSite.mdf;User Instance=True;Integrated Security=True;";
        _strConexao = @"Data Source=mysql02.jbmbrindes.com.br;Database=brindescpp; User ID=brindescpp; Password=brindescpp;pooling=false";
